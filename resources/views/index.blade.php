          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{ asset('assets-fornt/images/slider-dec.png') }}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="right-image">
            <img src="{{ asset('assets-fornt/images/about-right-dec.png') }}" alt="">
          </div>
        </div>
      </div>
    </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="client-content">
                                <img src="{{ asset('assets-fornt/images/quote.png') }}" alt="">
                                <p>“Lorem ipsum dolor sit amet, consectetur adpiscing elit, sed do eismod tempor idunte ut labore et dolore magna aliqua darwin kengan
                                  lorem ipsum dolor sit amet, consectetur picing elit massive big blasta.”</p>
                              </div>
                              <div class="down-content">
                                <img src="{{ asset('assets-fornt/images/client-image.jpg') }}" alt="">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="pricing-item-regular">
            ...
            <div class="icon">
              <img src="{{ asset('assets-fornt/images/pricing-table-01.png') }}
              " alt="">
            </div>
            <ul>
              <li>Lorem Ipsum Dolores</li>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-3">
        <div class="footer-widget">
          <h4>Contact Us</h4>
          <p>Bagdana Road, Gujarat, India</p>
          <p><a href="#">+91 98765 43210</a></p>
          <p><a href="#">support@repairhub.in</a></p>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        <div class="footer-widget">
          <h4>About Repair Hub</h4>
          <div class="logo">
            <img src="{{ asset('assets-fornt/images/white-logo.png') }}" alt="">
          </div>
          <p>We provide expert Mobile & Laptop repairing services with 100% customer satisfaction and genuine parts.</p>
        </div>
      </div>

      <div class="col-lg-12">
        <div class="copyright-text">
          <p>© 2025 Repair Hub. All Rights Reserved. <br>Design: <a href="https://templatemo.com/" target="_blank" title="css templates">TemplateMo</a></p>
        </div>
      </div>
    </div>
  </div>
